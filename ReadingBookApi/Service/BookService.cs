...
namespace ReadingBookApi.Service
{
    public class BookService : IBook
    {
        ...
        public async Task<ResponseVM> AddBook(BookAdminDetailVM book)
        {
            if (book == null)
            {
        ...
        public async Task<ResponseVM> Update(Guid id, BookAdminDetailVM book)
        {
            if (book == null)
            {
                var error = new ResponseVM
            ...
            else
            {
                ...
                if (bookUpdate != null)
                {
                    ...
                    var success = new ResponseVM
                    {
                        ...
                        IsSuccess = true,
                        Status = HttpStatusCode.OK.ToString(),
                        Data = new { response = _map.Map<BookAdminDetailVM>(bookUpdated) }
                    };
                    return success;
        ...
        public async Task<ResponseVM> UpdatePartial(Guid id, JsonPatchDocument<BookAdminDetailVM> book)
        {
            if (book == null)
            {
                var error = new ResponseVM
            ...
            else
            {
                ...
                if (bookDb != null)
                {
                    ...
                    var bookMapped = _map.Map<BookAdminDetailVM>(bookDb);
                    ...
                    var success = new ResponseVM
                    {
                        ...
                        IsSuccess = true,
                        Status = HttpStatusCode.OK.ToString(),
                        Data = new { response = _map.Map<BookAdminDetailVM>(bookPatched) }
                    };
                    return success;
